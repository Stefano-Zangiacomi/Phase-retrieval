...
Large_Speckle_intensity = double(imread('Digit_4_experimental_data.tif'));
%Large_Speckle_intensity = medfilt2(Large_Speckle_intensity,[3 3]);
disp(size(Large_Speckle_intensity))
%Large_Speckle_intensity = Spatial_Avg(Large_Speckle_intensity,9); %Augmente le SNR de x2
...
A1 = double(imread('Digit_4-240.png'));
...
sigma = 15; % sigma~(2D-3D) D is size of object, larger sigma ensure more information, but introduce more computational complexity  
...
%Large_Speckle_intensity = Large_Speckle_intensity(200:1000,200:1000);
[N_Speckle_1,N_Speckle_2] = size(Large_Speckle_intensity);
%% filter end
